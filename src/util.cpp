...
const char * const BITCOIN_CONF_FILENAME = "litenode.conf";
const char * const BITCOIN_PID_FILENAME = "litenoded.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Litenode";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Litenode";
#else
    // Unix
    return pathRet / ".litenode";
#endif
#endif
}
