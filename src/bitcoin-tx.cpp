...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s litenode-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  litenode-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded litenode transaction") + "\n" +
              "  litenode-tx [options] -create [commands]   " + _("Create hex-encoded litenode transaction") + "\n" +
              "\n";
