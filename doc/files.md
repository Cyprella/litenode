...
* litenode.conf: contains configuration settings for litenoded or litenode-qt
* litenoded.pid: stores the process id of litenoded while running
...
* debug.log: contains debug information and general logging generated by litenoded or litenode-qt
