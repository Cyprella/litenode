...
"""Verify that starting litenode with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start litenode with -h for help text")
        ...
        self.log.info("Start litenode with -version for version information")
